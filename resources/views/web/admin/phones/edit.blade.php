...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <!-- Header -->
        <div class="mb-8">
            <a href="{{ route('phones.show', $phone) }}" class="text-blue-600 hover:text-blue-800 flex items-center gap-2 mb-4">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                </svg>
                Quay lại chi tiết
            </a>
            <h1 class="text-3xl font-bold text-gray-800 mb-2">Chỉnh Sửa Điện Thoại</h1>
            <p class="text-gray-600">{{ $phone->title }}</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-8">
            ...
            <form action="{{ route('phones.update', $phone) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="time" 
                        name="time" 
                        value="{{ old('time', $phone->time) }}"
                        placeholder="VD: 2026, Q1 2026..."
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="subTitle" 
                        name="subTitle" 
                        value="{{ old('subTitle', $phone->subTitle) }}"
                ...
                <div>
                    ...
                    <textarea 
                        ...
                        name="content" 
                        rows="6"
                        placeholder="Nhập mô tả chi tiết về điện thoại..."
                    ...
                    >{{ old('content', $phone->content) }}</textarea>
                    @error('content')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
