...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-800 mb-2">Thêm bài viết Phone Mới</h1>
            <p class="text-gray-600">Điền thông tin chi tiết về bài viết phone mới</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-8">
            ...
            <form action="{{ route('phones.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf

                <!-- Tên Laptop -->
                <div>
                    <label for="title" class="block text-sm font-semibold text-gray-700 mb-2">
                        Tên tiêu đề bài viết <span class="text-red-500">*</span>
                    </label>
                    <input
                        type="text"
                        id="title"
                ...
                <div>
                    ...
                    <input
                        ...
                        name="time"
                        value="{{ old('time') }}"
                        placeholder="Nhập thời gian : Ví dụ August 1, 2018 ..."
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition @error('time') border-red-500 @enderror"
                    >
                    @error('time')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <textarea
                        ...
                        name="content"
                        rows="6"
                        placeholder="Nhập mô tả chi tiết về phone..."
