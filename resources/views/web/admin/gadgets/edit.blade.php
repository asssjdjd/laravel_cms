...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <!-- Header -->
        <div class="mb-8">
            <a href="{{ route('gadgets.show', $gadget) }}" class="text-blue-600 hover:text-blue-800 flex items-center gap-2 mb-4">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                </svg>
                Quay lại chi tiết
            </a>
            <h1 class="text-3xl font-bold text-gray-800 mb-2">Chỉnh Sửa Thiết Bị</h1>
            <p class="text-gray-600">{{ $gadget->title }}</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-8">
            ...
            <form action="{{ route('gadgets.update', $gadget) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="subTitle" 
                        name="subTitle" 
                        value="{{ old('subTitle', $gadget->subTitle) }}"
                ...
                <div>
                    ...
                    >{{ old('content', $gadget->content) }}</textarea>
                    @error('content')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex gap-4 pt-4">
                    ...
                    <a 
                        href="{{ route('gadgets.show', $gadget) }}" 
