...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-800 mb-2">Thêm Thiết Bị Mới</h1>
            <p class="text-gray-600">Điền thông tin chi tiết về thiết bị mới</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-8">
            ...
            <form action="{{ route('gadgets.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
