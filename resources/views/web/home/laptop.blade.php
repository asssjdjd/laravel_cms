    ...
    <!-- navigation -->
      ...
      <section id = "header">
        ...
        <!-- bottom header -->
         <div id="bottom-header">
            <ul id = "left-header">
                <li><a href="{{ route('user.home') }}"><img src="/images/logo.png" alt="" ></a></li>
            </ul>
            <ul id = "right-header">
                <div id = "header-nav">
                    <li class = "navbar-item effectFadeIn"><a href="{{ route('user.home') }}">Home</a></li>
                    <li class = "navbar-item active effectFadeIn"><a href="{{ route('user.laptops') }}">Laptop</a></li>
                    <li class = "navbar-item"><a href="{{ route('user.phones') }}">Phones</a></li>
                    <li class = "navbar-item"><a href="{{ route('user.gadgets') }}">Gadgets</a></li>
                    <li class = "navbar-item"><a href="{{ route('user.contact') }}">Contact Us</a></li>
                    <li class = "navbar-item"><a href="#">Download</a></li>
     ...
     <section id = "main">
        <div class="group-card">
            ...
            @empty
                <div class="main-card">No laptops found</div>
            @endforelse
        </div>
