...
@section('content')
     <section id = "nav-bar">
        <div class="container">
            <ul id ="hide-nav" class = "navbar-item" >
                ...
                <li class = "navbar-item-hide active"><a href="{{ route('user.laptops') }}">Laptop</a></li>
     ...
     <section id="visible-nav">
        <ul id = "navbar-items" class = "navbar-item" >
            ...
            <li class = "navbar-item active"><a href="{{ route('user.laptops') }}">Laptop</a></li>
    ...
    <section id="header">
        ...
        <div id="bottom-header">
            <ul id="left-header">
                <li><a href="{{ route('user.home') }}"><img src="/images/logo.png" alt="Logo"></a></li>
            </ul>
            <ul id="right-header">
                <div id="header-nav">
                    <li class="navbar-item"><a href="{{ route('user.home') }}">Home</a></li>
                    <li class="navbar-item"><a href="{{ route('user.laptops') }}">Laptop</a></li>
                    <li class="navbar-item active"><a href="{{ route('user.phones') }}">Phones</a></li>
                    <li class="navbar-item"><a href="{{ route('user.gadgets') }}">Gadgets</a></li>
                    <li class="navbar-item"><a href="{{ route('user.contact') }}">Contact Us</a></li>
                    <li class="navbar-item"><a href="#">Download</a></li>
    ...
    <section id="main">
        <div class="group-card">
            ...
            @empty
                <div class="main-card">No phones found</div>
            @endforelse
        </div>
        ...
        <div class="pagination">
            ...
            @else
                <a href="{{ $phones->previousPageUrl() }}" class="page-number">←</a>
            @endif
            ...
            @if($phones->hasMorePages())
                <a href="{{ $phones->nextPageUrl() }}" class="page-next">→</a>
            @else
        ...
        <div class="group-card">
            <div class="left-footer">
                <div class="footer-card foot_1">
                    <a href="{{ route('user.home') }}"><img src="/images/logo-white.png" alt="Logo"></a>
