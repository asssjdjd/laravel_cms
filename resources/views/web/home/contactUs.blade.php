    ...
    <!-- navigation -->
     <section id = "nav-bar">
        <div class="container">
            <ul id ="hide-nav" class = "navbar-item" >
                ...
                <li class = "navbar-item-hide active"><a href="{{ route('user.contact') }}">Contact Us</a></li>
     ...
     <section id="visible-nav">
        <ul id = "navbar-items" class = "navbar-item" >
            ...
            <li class = "navbar-item active"><a href="{{ route('user.contact') }}">Contact Us</a></li>
     ...
     <section id = "contact-us-main">
            <div class="contact-us-card-left">
                <h1>Contact Us</h1>
                <div style="margin: 20px 0px; font-size: 16px; font-weight: 400; color: rgb(54, 59, 64);">
                    This contact form is created using <a href="#" style="color: rgb(24, 88, 143)">Everest Forms.</a>
                </div>

                <form class="contact-form" method="POST" action="{{ route('user.contact.store') }}">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="messages" name="messages" rows="6">{{ old('messages') }}</textarea>
                        @error('messages')
                            <span class="error">{{ $message }}</span>
                        @enderror
                    </div>
            ...
            <div class="contact-us-card-right">
                <div class="search">
                    <input type="text" placeholder="Search..." style="font-size: 14px; color : #b5b5c3;border: 1px solid rgb(222, 226, 230);">
                    <img src="/front-practice/font-size/search.svg" class="search-icon" alt="icon">
                    <button class = "btn" style="padding: 10px; background-color: black; font-size: 12px; color: #fff;">SEARCH</button>
                </div>

                <div class="content">
                    <h3 class = "c_1">ARCHIVES</h3>
                    <ul>
      ...
      <button id="backToTop" class="back-to-top-btn">
                <span class="text" style="display: flex; align-items: center; justify-items: center; gap : 10px">
                    <span>Back To Top</span> <img src="/front-practice/font-size/arrow_forward_black.svg" alt=""></span>
            </button>
